...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '久信网', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.9zhu.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '筑爱网, 博客，久信网', // 网站关键词 英文逗号隔开
